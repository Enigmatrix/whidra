...
open class BinaryController { // TODO allOpen is bugged?
    ...
    open fun functions(session: Session, @RequestBean param: BinaryParam): List<Function> { // TODO suspend here writes wrong parameter values
        println("{ bin: ${param.binary}, repo: ${param.repository} }")
        TODO("unimplemented")
    }
